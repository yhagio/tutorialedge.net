...
desc:
  In this tutorial we discuss how to set up a UDP client and server using
  datagramsockets in Java
series: java
image: java.png
tags:
  - java
...
In this tutorial we’ll be looking at how we can set up a UDP client and server
using Java’s DatagramSocket’s.
